...
export default function JobApplicationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (existingApplicationId) {
      setSubmitError('You have already applied for this position. Please check your application status.');
        ...
        <Container maxWidth="md">
          <Card>
            <CardContent sx={{ p: 4, textAlign: 'center' }}>
              ...
              <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
                Thank you for applying to {job.title}. Your application has been received and is under review.
              </Typography>
      ...
      <Container maxWidth="md">
        ...
        <Card>
          <CardContent sx={{ p: 4 }}>
            ...
            {existingApplicationId && !submitError && (
